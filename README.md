...
Then, to install, for example, v3.0.0, use the following:

    sudo pip install --extra-index https://pypi.airfire.org/simple blueskykml==3.0.0
...
cloning the repo.  e.g. To install v3.0.0, use ```git checkout v3.0.0```.
