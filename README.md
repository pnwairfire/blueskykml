...
Then, to install, for example, v4.0.3, use the following:

    sudo pip install --extra-index https://pypi.airfire.org/simple blueskykml==4.0.3
...
cloning the repo.  e.g. To install v4.0.3, use ```git checkout v4.0.3```.
