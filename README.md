...
Then, to install, for example, v0.2.8, use the following:

    sudo pip install --no-binary gdal --trusted-host pypi.smoke.airfire.org -i http://pypi.smoke.airfire.org/simple blueskykml==0.2.8
...
cloning the repo.  e.g. To install v0.2.8, use ```git checkout v0.2.8```.
