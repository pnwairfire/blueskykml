...
Then, to install, for example, v2.3.0, use the following:

    sudo pip install --extra-index https://pypi.airfire.org/simple blueskykml==2.3.0
...
cloning the repo.  e.g. To install v2.3.0, use ```git checkout v2.3.0```.
