...
Then, to install, for example, v6.0.6, use the following:

    sudo pip install --extra-index https://pypi.airfire.org/simple blueskykml==6.0.6
...
cloning the repo.  e.g. To install v6.0.6, use ```git checkout v6.0.6```.
