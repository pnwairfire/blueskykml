...
Then, to install, for example, v5.0.0, use the following:

    sudo pip install --extra-index https://pypi.airfire.org/simple blueskykml==5.0.0
...
cloning the repo.  e.g. To install v5.0.0, use ```git checkout v5.0.0```.
