...
Then, to install, for example, v1.0.1, use the following:

    sudo pip install --trusted-host pypi.smoke.airfire.org -i http://pypi.smoke.airfire.org/simple blueskykml==1.0.1
...
cloning the repo.  e.g. To install v1.0.1, use ```git checkout v1.0.1```.
